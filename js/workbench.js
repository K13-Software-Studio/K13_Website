...
function tiger(mount){
  ...
  wrap.innerHTML='<svg class="wb-svg" viewBox="0 0 320 220" preserveAspectRatio="xMidYMid slice" role="img" aria-label="An abstract map of the San Diego coastline"><path class="wb-sea" d="M0 0h320v220H0z"/><path class="wb-land" d="M96 0c-6 22-4 44 2 66 4 14-2 26-10 36-10 14-6 30 4 40 8 8 6 20-2 30-6 8-10 18-6 28l6 20h230V0z"/><path class="wb-bay" d="M84 136c8 6 20 6 28 0 8-8 6-22-4-26-10-4-24 2-26 12-1 5 0 10 2 14z"/><path class="wb-coast" d="M96 0c-6 22-4 44 2 66 4 14-2 26-10 36-10 14-6 30 4 40 8 8 6 20-2 30-6 8-10 18-6 28l6 20" fill="none"/><text class="wb-legend" x="14" y="206">Pacific</text><g class="wb-pins"></g><g class="wb-ghost" aria-hidden="true"><path d="M0 -22a8 8 0 0 1 8 8c0 6-8 14-8 14s-8-8-8-14a8 8 0 0 1 8-8z"/></g></svg>';
